  ...
  return (
    <section className="relative isolate overflow-hidden bg-primary px-6 lg:px-8">
      <div className="relative mx-auto max-w-2xl py-20 sm:py-28 lg:max-w-4xl">
        ...
        <div className="shadow-primary-600/10 lg:-mr-26 absolute inset-y-0 right-1/2 -z-10 mr-12 w-[150vw] origin-bottom-left skew-x-[-30deg] bg-primary shadow-xl ring-1 ring-secondary sm:mr-20 md:mr-0 lg:right-full lg:origin-center" />
