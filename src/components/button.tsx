...
const variants = {
  ...
  secondary: clsx(
    ...
    'rounded-full border border-transparent bg-light/15 shadow-md ring-1 ring-[#D15052]/15',
    'after:absolute after:inset-0 after:rounded-full after:shadow-[inset_0_0_2px_1px_theme(colors.light/30%)]',
    'whitespace-nowrap text-base font-medium text-gray-950',
    'data-[disabled]:bg-light/15 data-[hover]:bg-light/20 data-[disabled]:opacity-40',
  ),
  outline: clsx(
